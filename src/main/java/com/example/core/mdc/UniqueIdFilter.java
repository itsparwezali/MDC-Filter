...
import com.example.core.config.ConfigurationFilter;
import lombok.*;
...
public class UniqueIdFilter extends OncePerRequestFilter {
	...
	public UniqueIdFilter() {
		responseHeader = ConfigurationFilter.DEFAULT_HEADER_TOKEN;
		mdcKey = ConfigurationFilter.DEFAULT_MDC_UUID_TOKEN_KEY;
		requestHeader = ConfigurationFilter.DEFAULT_HEADER_TOKEN;
	}
